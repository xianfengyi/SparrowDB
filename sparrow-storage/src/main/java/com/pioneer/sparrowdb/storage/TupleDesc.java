...
public class TupleDesc implements Serializable {
    ...
    public static class TDItem implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof TDItem) {
                ...
                boolean nameEquals =
                        (fieldName == null && another.fieldName == null) || fieldName.equals(another.fieldName);
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        for (int i = 0; i < tdItems.length; i++) {
            if ((fieldName = tdItems[i].fieldName) != null && fieldName.equals(name)) {
                return i;
            }
        }
        throw new NoSuchElementException();
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
        TDItem[] tdItems1 = td1.tdItems;
        TDItem[] tdItems2 = td2.tdItems;
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof TupleDesc) {
            ...
            for (int i = 0; i < numFields(); i++) {
                if (!tdItems[i].equals(another.tdItems[i])) {
                    return false;
                }
            }
            return true;
